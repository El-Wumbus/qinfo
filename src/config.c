...
handler (void *user, const char *section, const char *name, const char *value)
{
    ...
    if (MATCH ("Display", "DISPLAY_CPU_INFO"))
        ...
        {
            pconfig->DISPLAY_OPERATING_SYSTEM = (strcmp (value, "true") == 0) ? true : false;
        }
        ...
        {
            pconfig->DISPLAY_KERNEL_VERSION = (strcmp (value, "true") == 0) ? true : false;
        }
    else if (MATCH ("Display", "DISPLAY_ROOTFS_BIRTHDAY"))
        {
            pconfig->DISPLAY_ROOTFS_BIRTHDAY = (strcmp (value, "true") == 0) ? true : false;
        }
        ...
        {
            pconfig->DISPLAY_MOTHERBOARD_INFO = (strcmp (value, "true") == 0) ? true : false;
        }
